...
- If the user's reply seems incomplete or suggests they want to continue (e.g. “I'll continue”, “and also”, unfinished lists), wait. Ask if they want to add more or move on.
